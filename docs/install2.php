...
$titletext = "TrafficDX - Installation";
...
?>
<h1>TrafficDX Installation...</h1>
<p align="justify">
<br>
<b>Step Number 2:</b>
<br><br>
Enter the name of a new database that you would like to create for use with your TrafficDX software, then click on the "Add Db" button. Your new database will be created for you and a screen will appear to click "Back". Click on the Back link.
<br><br>
Note: Your database name will usually be assigned as AccountName_DatabaseName. Write this info down since you will need it later.
</p>
...
<tr>
<td align="center"><img src="images/mysql2.jpg"></td>
</tr>
</table>
<a href="install1.php"><font face="Symbol" size="2">Ü</font> Back</a>&nbsp;&nbsp;&nbsp;<a href="index.php">Home</a>&nbsp;&nbsp;&nbsp;<a href="install3.php">Next <font face="Symbol" size="2">Þ</font></a><br>
</center>
<br>
</td>
<?php 
